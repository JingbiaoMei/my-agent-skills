# Recommended Agent Skills for AI PhD Researchers

This comprehensive guide is tailored for high-rigor AI PhD workflows. It provides verified links and installation commands for tools ranging from systematic literature discovery to journal-quality visualization.
...
1.  **Discovery & Gathering**: Use **Research-Superpower** for systematic searches and **Zotero Code Execution** to manage large libraries without context crashes.
2.  **Autonomous Research**: Deploy **Browser-Use** for deep-web data gathering and **Lead Research Assistant** to coordinate complex synthesis tasks.
3.  **Critical Analysis**: Apply **Scientific Critical Thinking** and **Academic Writing (CS)** to ensure methodology and narrative meet publication standards.
4.  **Visualization & Presentation**: Generate journal-ready figures with **draw.io** and high-density slides with **Tufte Slide Design** or **Slidev**.

---

## 1. Literature Review & Research Infrastructure
*Goal: Large-scale citation management and systematic discovery.*
...
## 2. Writing, Editing & Automation
*Goal: Publication-quality drafting and autonomous web interaction.*
...
## 3. Diagramming & Data Visualization
*Goal: SVG/Vector figures and high-fidelity technical schemas.*
...
## 4. Project Webpages & UI/UX
*Goal: State-of-the-art project landing pages and interactive demos.*
...
## 5. Scientific Posters & Presentations
*Goal: Conference deliverables and slide decks.*
...
*Goal: Code management and dependency updates.*
...
## Installation Options Note

**Global and Multi-Agent Installation:**
...
When installing and using agent skills, follow these security guidelines:

1. **Only install from reputable repos** - Prefer skills from well-known organizations, verified authors, or repositories with active maintenance and community engagement.

2. **Inspect SKILL.md + any scripts** - Before installation, review the skill's `SKILL.md` file and any associated scripts to understand what commands and operations the skill will execute.

3. **Avoid dangerous installation patterns** - Be wary of skills that ask you to run:
   - `curl | bash` pipelines
   - Obfuscated or encoded commands
   - Commands that require sudo/root without clear justification
